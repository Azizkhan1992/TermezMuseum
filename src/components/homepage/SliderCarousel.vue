...
export default {
  ...
  data() {
    return {
      ...
      sliderItems: [
        {id: 1, img: 1, title: '1Музей - центр культуры и просвещения', link: ''},
        {id: 2, img: 2, title: '2Музей - центр культуры и просвещения', link: ''},
        {id: 3, img: 3, title: '3Музей - центр культуры и просвещения', link: ''},
        {id: 4, img: 4, title: '4Музей - центр культуры и просвещения', link: ''},
        {id: 5, img: 5, title: '5Музей - центр культуры и просвещения', link: ''},
      ]
    }
  },
