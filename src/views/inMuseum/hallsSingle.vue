<template>
  <div class="mainPage">
    ...
    <h1 class="grandTitle w-100 mt-120">{{title}}</h1>

    <div class="w-100 mt-60">
      <img class="w-100 obj-fit-cov" src="@/assets/temporary/building-scheme.png" alt="">
    </div>

    <h3 v-html="description" class="commonD reg mt-60">
    </h3>
